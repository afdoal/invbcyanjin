...
$html = '<h2 align="center">'.$NmMenu.'</h2>'.				
		...
		<tr>
		  ...
		  <th width="60"><b>PO Date</b></th>
		  <th width="150"><b>Seller</b></th>
		  <th width="80"><b>Attn.</b></th>
		  <th align="right" width="50"><b>PPN (%)</b></th>
		  <th><b>Terms</b></th>
...
$html .= '<tr>'.
		 ...
		 '<td width="60">'.$r['po_date'].'</td>'.
		 '<td width="150">'.$r['supplier'].'</td>'.
		 '<td width="80">'.$r['attn'].'</td>'.
		 '<td align="right" width="50">'.$r['ppn'].'</td>'.
		 '<td>'.$r['terms'].'</td>'.

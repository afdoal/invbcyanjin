...
$html = '<h2 align="center">'.$NmMenu.'</h2>'.				
		...
		<tr>
		  ...
		  <th width="80"><b>WO Date</b></th>
		  <th width="100"><b>PO Cust. No.</b></th>
		  <th width="100"><b>Export Plan Date</b></th>
		  <th><b>Notes</b></th>
		</tr>
		</thead>
		<tbody>';
...
$html .= '<tr>'.
		 ...
		 '<td width="80">'.$r['wo_date'].'</td>'.
		 '<td width="100">'.$r['so_no'].'</td>'.
		 '<td width="100">'.$r['expplan_date'].'</td>'.
		 '<td>'.$r['notes'].'</td>'.
		 '</tr>';
$no+=1;	
}

...
<tbody>
<tr>
  <td align="center" colspan="2" valign="middle"><h2>BC 4.0 </h2></td>
...
<tr>
    ...
    <td class="nobordertr" width="43"></td>
    <td class="nobordertr" width="11"></td>
    <td width="75" class="nobordertr"></td>
...
<tr>
  ...
  <td class="noborderright">:</td>
  <td colspan="5"><?php echo $_SESSION['NoTpb'] ?> TGL <?php echo strToupper(ymd2dmy3($_SESSION['TgTpb'])) ?></td>
  <td colspan="9">&nbsp;</td>
</tr> 
<tr>

...
<body>
<h5>LAPORAN PEMASUKAN BARANG PER DOKUMEN <?php echo $UrJnsDok ?><br>KAWASAN BERIKAT <?php echo $_SESSION['c_name'] ?><br>LAPORAN PEMASUKAN BARANG PER DOKUMEN <?php echo $UrJnsDok ?><br>PERIODE <?php echo $dtdari." S.D ".$dtsampai ?></h5>

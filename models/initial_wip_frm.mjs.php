...
function setdg(){
	...
	$('#dg').datagrid({  	
		...
		url: '<?php echo $basedir; ?>models/initial_wip_grid.php?req=list2&wh_id='+wh_id+'&date='+date,  
...
function setdgCari(){	
	$('#dgCari').datagrid({  
		...
		url: '<?php echo $basedir ?>models/initial_wip_grid.php?req=menu&pilcari='+$("#pilcari").val(), 
...
function topdf(){
	...
	openurl('<?=$basedir?>masterdata/initial_wip_pdf.php?NmMenu=<?=$NmMenu?>&wh_id='+wh_id+'&date='+date);
}

...
$q4 = "SELECT COUNT(*) AS jml4 FROM header a WHERE a.DokKdBc='5' AND KdTp='3' ";
$q5 = "SELECT COUNT(*) AS jml5 FROM header a WHERE a.DokKdBc='5' AND KdTp IN ('6','7','8') ";
...
$q13 = "SELECT COUNT(*) AS jml13 FROM header a WHERE a.DokKdBc='4' AND KdTp='3' ";
$q14 = "SELECT COUNT(*) AS jml14 FROM header a WHERE a.DokKdBc='4' AND KdTp IN ('6','7','8') ";

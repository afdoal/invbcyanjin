...
try {	
	...
	if ($aksi=='t'){
		...
		$sql[] = "INSERT INTO mat_opnamehdr (
				  ...
				  '$opname_id','$opname_date','11','$wh_id',
				  '$tot_qty','$notes'
				  )";	
		//AKHIR TAMBAH HEADER
		...
		$sql[] = "INSERT INTO mat_opnamedet (
				  opname_id,child_no,mat_id,qty,weight,remark
				  ) VALUES (
				  '$opname_id','$nolist[$i]','$KdBarang2[$i]','$qty[$i]','$weight[$i]','$remark[$i]'
				  )";	
		}//AKHIR TAMBAH DETAIL

...
function showPrint(){
	...
	openurl('mutasi_mat_list_pdf.php?NmMenu=Laporan Pertanggunjawaban<br>Mutasi Barang Sisa dan Scrap&mat_type=12&date1='+$("#date1").datebox('getValue')+'&date2='+$("#date2").datebox('getValue')+'&page='+opts.pageNumber+'&rows='+opts.pageSize);
}

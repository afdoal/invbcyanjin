...
function setdg(){
	...
	$('#dg').datagrid({  	
		...
		url: '<?php echo $basedir; ?>models/material/stock_adjustwip_grid.php?req=list2&bln='+bln+'&thn='+thn+'&wh_id='+wh_id
	});
}
...
function loaddg(){
	...
	$('#dg').datagrid({  	
		...
		url: '<?php echo $basedir; ?>models/material/stock_adjustwip_grid.php?req=load&bln='+bln+'&thn='+thn+'&wh_id='+wh_id
	});
	<?php /*openurl('<?php echo $basedir; ?>models/material/stock_adjustwip_grid.php?req=load&bln='+bln+'&thn='+thn+'&wh_id='+wh_id);**/?>
}
...
function simpan(){
	...
	if ($('#bulan').val() == ''){ 
		...
		$.post("<?php echo $basedir ?>models/material/stock_adjustwip_tuh.php", { 
		aksi: $('#aksi').val(), 

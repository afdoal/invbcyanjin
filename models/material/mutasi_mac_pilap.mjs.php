...
function showPrint(){
	...
	openurl('mutasi_mac_list_pdf.php?NmMenu=Laporan Pertanggunjawaban<br>Mutasi Mesin dan Peralatan Perkantoran&mat_type=1&date1='+$("#date1").datebox('getValue')+'&date2='+$("#date2").datebox('getValue')+'&page='+opts.pageNumber+'&rows='+opts.pageSize);
}

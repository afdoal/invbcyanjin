...
function showPrint(){
	...
	openurl('mutasi_fg_list_pdf.php?NmMenu=Laporan Pertanggungjawaban<br>Mutasi Barang Jadi&mat_type=0&date1='+$("#date1").datebox('getValue')+'&date2='+$("#date2").datebox('getValue')+'&page='+opts.pageNumber+'&rows='+opts.pageSize);
}
